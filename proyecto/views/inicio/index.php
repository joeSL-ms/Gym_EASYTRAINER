...
<head>
  ...
  <link rel="stylesheet" href="../../assets/CSS/home_sup.css">
...
<body>
  ...
  <footer class="section-footer" id="footer">
    ...
    <!-- <script src="js.js"></script> necesito una explicacion del uso de este script o si iba a tener algun propocito-->
